...
router.put( "/id/:_id", authentication, isAuthor, isAdmin, uploadEventImages.single('image'), EventController.update);
router.put("/like/:_id", authentication, EventController.like);
router.put("/dislike/:_id", authentication, EventController.dislike);

router.delete("/delete/:_id", authentication, isAuthor, isAdmin, EventController.delete);
